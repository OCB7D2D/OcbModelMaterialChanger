...
SET NAME=0cbModelMaterialChanger
SET ANAME=OcbModelMaterialChanger
...
cd build
echo Packaging %ANAME%-%VERSION%.zip
powershell Compress-Archive %NAME% %ANAME%-%VERSION%.zip -Force
cd ..
